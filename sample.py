...
class CFGParser:
    def __init__(self, tokens):
        ...
        self.grammar_rules = {
            ...
            '<update_exp>': [
                [TT_IDENTIFIER, '<update_exp_op>', '<update_exp_tail>'],
                ['lambda']
            ],
            '<update_exp_op>': [
                [TT_INC],
            ...
            '<seek_statement>': [[TT_INPUT, TT_LPAREN,TT_STRING_LITERAL, '<memory_address>', TT_RPAREN]],
        ...
        self.first_sets = {
            ...
            "<update_exp>": {TT_IDENTIFIER, 'lambda'},
            ...
            "<parameter>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, 'lambda'},
            "<parameter_tail>": {TT_COMMA, 'lambda'},
            "<statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_RETURN, TT_OUTPUT, TT_INPUT, 'lambda'},
            "<declaration_statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST},
            "<assign_or_call_statement>": {TT_IDENTIFIER},
            "<tail>": {TT_LPAREN, TT_EQUAL, TT_PLUSAND, TT_MINUSAND, TT_MULAND, TT_DIVAND, TT_MODAND, TT_LBRACKET, TT_INC, TT_DEC},
            ...
            "<ledger_assign_tail>": {TT_NEWLINE, 'lambda'},
            ...
            "<emit_value>": {TT_STRING_LITERAL},
            #"<emit_tail>": {TT_STRING_LITERAL, 'lambda'},
            #"<format_specifier>": {TT_FORMATSPEC},
        ...
        self.follow_sets ={
            "<program>": {TT_EOF},
            "<global>": {TT_MAIN, TT_EOF},
            "<declare>": {TT_TERMINATE},
            "<var_declaration>": {TT_EQUAL, TT_LBRACKET, TT_COMMA, TT_TERMINATE},
            "<declare_tail>": {TT_TERMINATE},
            "<var_declaration_assign>": {TT_TERMINATE},
            "<var_declaration_tail>": {TT_TERMINATE},
            "<ledger_element>": {TT_EQUAL, TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL, TT_PLUSAND, TT_MINUSAND, TT_MULAND, TT_DIVAND, TT_MODAND},
            ...
            "<value>": {TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL}, 
            "<value_tail>": {TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},  
            "<var_name>": { TT_LPAREN, TT_LBRACKET, TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_FORMATSPEC, TT_STRING_LITERAL}, 
            "<primary_value>": {TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_COMMA, TT_TERMINATE, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN,TT_FORMATSPEC, TT_STRING_LITERAL},
            "<expression>": {TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},
            "<expression_tail>": {TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},
            "<literal>": {TT_COMMA, TT_RBRACE, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},
            "<veracity_lit>": {TT_COMMA, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},
            "<not_op>": {TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_COMMA, TT_TERMINATE, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN,TT_FORMATSPEC, TT_STRING_LITERAL},
            "<op>": {TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN},
            "<arith_op>": {TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN},
            "<logic_op>": {TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN},
            "<compare_op>": {TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN},
            "<equality_op>":{TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN},
            "<update_exp>": {TT_TERMINATE, TT_RPAREN, TT_BREAK, TT_CONTINUE, TT_RBRACE},
            "<update_exp_op>": {TT_COMMA, TT_TERMINATE, TT_RPAREN, TT_BREAK, TT_CONTINUE, TT_RBRACE},
            "<update_exp_tail>": {TT_COMMA, TT_RPAREN, TT_BREAK, TT_CONTINUE, TT_RBRACE},
            "<function_call_statement>": {TT_COMMA, TT_RBRACE, TT_TERMINATE, TT_PLUS, TT_MINUS, TT_MUL, TT_DIV, TT_MODULO, TT_AND, TT_OR, TT_LESSTHAN, TT_GREATERTHAN, TT_LESSTHANEQUAL, TT_GREATERTHANEQUAL, TT_EQUALTO, TT_NOTEQUAL, TT_RPAREN, TT_COLON, TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN, TT_FORMATSPEC, TT_STRING_LITERAL},
            "<argument>": {TT_RPAREN},
            "<argument_tail>": {TT_RPAREN},
            "<function>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_FUNCTION, TT_MAIN, TT_EOF},
            "<return_type>": {TT_IDENTIFIER},
            "<parameter>": {TT_RPAREN},
            "<parameter_tail>": {TT_RPAREN},
            "<statement>": {TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT, TT_CONTINUE, TT_IDENTIFIER, TT_TERMINATE},
            "<declaration_statement>": {TT_TERMINATE},
            "<assign_or_call_statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<tail>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<value_assign>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<value_assign_tail>": {TT_TERMINATE},
            "<ledger_assign>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<ledger_assign_tail>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<assignment_op>": {TT_IDENTIFIER, TT_INT_LITERAL, TT_FLOAT_LITERAL, TT_CHAR_LITERAL, TT_STRING_LITERAL, TT_TRUE, TT_FALSE, TT_NOT, TT_LPAREN,},
            "<conditional_statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<condition>": {TT_RPAREN, TT_TERMINATE},
            "<or-opt>":{TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<or-tail>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<shift_statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<opt_value>": {TT_DEFAULT, TT_RBRACE},
            "<opt_tail>": {TT_DEFAULT, TT_RBRACE},
            "<halt_value>": {TT_CASE, TT_DEFAULT, TT_RBRACE},
            "<usual_value>": {TT_RBRACE},
            "<loop_statement>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<per_loop>":  {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<initialization_statement>": {TT_TERMINATE},
            "<until_loop>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            "<act-until_loop>": {TT_INT, TT_FLOAT, TT_CHAR, TT_STRING, TT_BOOL, TT_CONST, TT_IDENTIFIER, TT_IF, TT_SWITCH, TT_FOR, TT_WHILE, TT_DO, TT_OUTPUT, TT_INPUT, TT_RETURN,  TT_IDENTIFIER, TT_RBRACE, TT_BREAK, TT_CASE, TT_DEFAULT ,TT_CONTINUE, TT_TERMINATE},
            ...
            #"<format_specifier>": {TT_FORMATSPEC, TT_STRING_LITERAL},
    ...
    def parse(self):
        ...
        while stack:
            ...
            print(f"TOP: {top}, CURRENT TOKEN: {current_token}")  # Debugging output
            print(f"First({top}) = {self.first_sets.get(top, set())}")  # Debugging FIRST set
            ...
            if top in self.first_sets or top == "lambda":
                ...
                if matched_production:
                    ...
                    node = Node(top)
                    if parent:
                        parent.children.append(node)  # Siguraduhin na na-append sa parent
                    stack.pop()  # Alisin ang current non-terminal
                    if production != ['lambda']:
                        for symbol in reversed(production):
                            stack.append((symbol, node))  # I-attach sa tamang node
                    else:
                        node.children.append(Node("lambda"))  # Gawing explicit na lambda node
                else:
                    expected_tokens = set()
                    for prod, preds in self.predict_sets.items():
                    ...
                    error_token = self.tokens[self.current_token_index]
                    return InvalidSyntaxError(
                        error_token.pos_start,
                        error_token.pos_end,
                        f"Unexpected token '{error_token.type}'.\nExpected one of: {expected_tokens}"
                    )
                ...
                return InvalidSyntaxError(
                    error_token.pos_start,
                    error_token.pos_end,
                    f"Expected '{top}', but found '{error_token.type}'"
                )
...
def test_parser():
    tokens = [
        Tokens(TT_MAIN, "Embark"),
        Tokens(TT_LPAREN, "("),
        Tokens(TT_RPAREN, ")"),
        Tokens(TT_LBRACE, "{"),
        Tokens(TT_INT, "Numeral"),
        Tokens(TT_IDENTIFIER, "x"),
        Tokens(TT_EQUAL, "="),
